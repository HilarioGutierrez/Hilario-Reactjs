    ...
    return (
        <Box border='2px' display='flex' flexDirection='row' borderColor='#857c8d' justifyContent='space-around' margin='auto' borderRadius={10} padding={1} alignItems='center' >
            ...
            <Box display='flex' flexDirection='row' justifyContent='center' alignItems='center'>
                <Button marginBottom={8} bgColor='#68b684' margin='5' textColor='#fffffc' disabled={stock <= 0 && contador > stock} _disabled={{ bg: 'grey' }} _hover={{ bg: '#5f1e3b' }} onClick={() => onAdd(contador)}>Comprar</Button>
